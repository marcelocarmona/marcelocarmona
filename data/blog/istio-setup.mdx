---
title: Setting up Istio
date: '2021-08-05'
tags: ['Kubernetes', 'Cloud native', 'Devops']
summary: 'How to set up Istio, an open-source service mesh, including installation, configuration, and integration with other tools. It enables a more efficient and unified way to secure, connect, and monitor services in distributed applications.'
draft: false
---
...
<img
  ...
  alt="check Kubernetes namespaces after installing istioctl"
/>
...
<img src="/static/images/blog/istio-setup-12.png" alt="check the new pods" />
...
<img src="/static/images/blog/istio-setup-addons-4.png" alt="port-forward frontend" />

Run `kubectl port-forward svc/kiali -n istio-system 20001`.

<img src="/static/images/blog/istio-setup-addons-5.png" alt="port-forward Kiali" />

Go to http://localhost:20001/ and you will see the Kiali dashboard.

<img src="/static/images/blog/kiali.png" alt="Kiali screenshot" />
