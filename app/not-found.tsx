    ...
    <div className="space-y-10">
      <div className="flex flex-col items-start justify-start md:mt-24 md:flex-row md:items-center md:justify-center md:space-x-6">
        ...
        <div className="max-w-md">
          ...
          <Link href="/">
            <button className="inline rounded-lg border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium leading-5 text-white shadow-sm transition-colors duration-150 hover:bg-blue-700 focus:outline-hidden focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-white dark:hover:bg-blue-500 dark:focus:ring-offset-gray-900">
              Back to homepage
            </button>
          </Link>
        </div>
      ...
      <div className="grid gap-8 border-t border-gray-200 pt-8 dark:border-gray-700 md:grid-cols-2">
        <section>
