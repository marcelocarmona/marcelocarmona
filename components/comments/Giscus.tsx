...
const Giscus = () => {
  ...
  const LoadComments = useCallback(() => {
    ...
    script.setAttribute('data-reactions-enabled', reactions || '1')
    script.setAttribute('data-emit-metadata', metadata || '0')
  ...
  return (
    <div className="pb-6 pt-6 text-center text-muted-foreground">
