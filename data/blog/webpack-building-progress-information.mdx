---
title: Webpack build progress information
date: '2016-09-05'
translationKey: webpack-progress
summary: '"webpack-dashboard" is a webpack plugin that shows detailed information about module size, progress, errors, and assets in the development environment. It was created by Formidable, and there are several ways to install and use it.'
...
<img
  src="/static/images/blog/webpack-dashboard-dev-server.png"
  alt="webpack dashboard common example"
/>
...
<img
  src="/static/images/blog/webpack-dashboard-screen-shot.png"
  alt="webpack dashboard screenshot"
/>
...
<blockquote data-lang="es">
  <p lang="en" dir="ltr">
    Up on the blog: <a href="https://twitter.com/ken_wheeler">@ken_wheeler</a> introduces Webpack
    Dashboard, a CLI dashboard for your Webpack-dev-server{' '}
    <a href="https://t.co/1jD1Q8lWRn">https://t.co/1jD1Q8lWRn</a>
  </p>
...
<blockquote data-lang="es">
  <p lang="en" dir="ltr">
    Excited to announce the first turbo alpha version of webpack-dashboard is now released!{' '}
    <a href="https://t.co/OnYvgwHmXC">https://t.co/OnYvgwHmXC</a>{' '}
    <a href="https://t.co/tATG2TMoNj">pic.twitter.com/tATG2TMoNj</a>
  </p>
...
<blockquote data-lang="es">
  <p lang="en" dir="ltr">
    Built me a webpack console dashboard, with progress, status, build logs and browser console.
    I&#39;m tired. <a href="https://t.co/uoOz81Nf3M">pic.twitter.com/uoOz81Nf3M</a>
  </p>
  &mdash; Ken Wheeler (@ken_wheeler){' '}
...
<blockquote data-lang="es">
  <p lang="en" dir="ltr">
    Webpack Dashboard: 3k stars in 2 days. Huge demand for better UX in dev tools. Take note!{' '}
    <a href="https://t.co/QLY6qrODZK">https://t.co/QLY6qrODZK</a>{' '}
    <a href="https://t.co/AgRWA9o8TM">pic.twitter.com/AgRWA9o8TM</a>
  </p>
